...
<head>
  ...
  <style>
    ...
    * {
    ...
    .tag-fact { background: #e2e8f0; color: #1e293b; border: 1px solid #cbd5e1; }
    .tag-capability { background: #dbeafe; color: #1e40af; border: 1px solid #bfdbfe; }
    .tag-management { background: #f3e8ff; color: #6b21a8; border: 1px solid #e9d5ff; }
    .tag-market { background: #dcfce7; color: #166534; border: 1px solid #bbf7d0; }
